        ...
        for (let i = 0; i < pack.length; i++) {
          //console.log(packs);
            ...
            if(pack[i].name == "Metro"){
                ...
                document.getElementById('priceM').innerHTML = 'Precio: $' + pack[i].price + ' per day';
                ...
                document.getElementById('priceA').innerHTML = 'Precio: $' + pack[i].price  + ' per day';
                ...
                document.getElementById('priceP').innerHTML = 'Precio: $' + pack[i].price + ' per day';
                ...
                document.getElementById('priceD').innerHTML = 'Precio: $' + pack[i].price + ' per day';
                ...
                document.getElementById('price4').innerHTML = 'Precio: $' + pack[i].price + ' per day';
                ...
                document.getElementById('price2').innerHTML = 'Precio: $' + pack[i].price + ' per day';
